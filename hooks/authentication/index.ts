...
} from "@/app/trash/forms/forgot-password/schema"
import { SignUpSchema } from "@/app/trash/forms/sign-up/schema"
import { signInSuccessUrl } from "@/constants"
...
import { z } from "zod"
import { SignInSchema } from "../../app/trash/forms/sign-in/schema"

export const useAuthSignIn = () => {
  const { isLoaded, setActive, signIn } = useSignIn()
  const {
    register,
    formState, // Destructure the entire formState object
    reset,
    handleSubmit,
    getValues,
