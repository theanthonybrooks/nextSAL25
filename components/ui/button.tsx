  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium  transition-colors   disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        salWithShadowYlw:
          "bg-salYellow shadow-slg text-black hover:shadow-smd active:shadow-none border-2 border-black focus:shadow-smd",
        salWithShadowPink:
          "bg-salPink shadow-slg text-black hover:shadow-ssm active:shadow-smd border-2 border-black focus:shadow-smd",
      },
      size: {
